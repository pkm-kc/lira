...
class HealthConnectManager(private val context: Context) {
    ...
    suspend fun readHearRates(start: Instant, end: Instant): List<HeartRateRecord> {
    ...
    suspend fun readBloodPressures(start: Instant, end: Instant): List<BloodPressureRecord> {
        val request = ReadRecordsRequest(
